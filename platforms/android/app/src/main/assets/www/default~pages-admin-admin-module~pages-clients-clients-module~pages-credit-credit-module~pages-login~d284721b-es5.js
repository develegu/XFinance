...
var MyModal = /** @class */ (function () {
    function MyModal(modalCtrl, db, gf) {
    ...
    MyModal.prototype.ngOnInit = function () {
        var _this = this;
        ...
        if (this.type === 'Cliente' && this.Tipo === _constants__WEBPACK_IMPORTED_MODULE_5__["gv"].Actualizar) {
            ...
            var ArrNombre = this.Info_Cliente[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].nombre].split('_');
            console.log(ArrNombre);
            this.Cliente.Nombre = ArrNombre[0];
            this.Cliente.ApellidoP = ArrNombre[1];
            this.Cliente.ApellidoM = ArrNombre[2];
            var ArrDireccion = this.Info_Cliente[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].direccion].split('_');
        ...
        if (this.type === 'Pago') {
            this.PagosArr = _constants__WEBPACK_IMPORTED_MODULE_5__["gv"].pagos_Arr.filter(function (pago) {
                return pago[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].key_primer_pago] === _this.Key_Primer_Pago;
            });
            this.PagosArr.sort(function (a, b) { return a[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].num_pago] - b[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].num_pago]; });
            this.ProximosArr = this.PagosArr.filter(function (pago) {
            ...
            this.ProximosArr.sort(function (a, b) { return a[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].num_pago] - b[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].num_pago]; });
    ...
    MyModal.prototype.closeModal = function () {
    ...
    MyModal.prototype.AgregarUsuario = function () {
        var _this = this;
    ...
    MyModal.prototype.GetCurp = function () {
        if (this.Cliente.ApellidoP !== '' && this.Cliente.ApellidoM !== '' && this.Cliente.Nombre !== '' &&
            ...
            var fecha = new Date(this.Cliente.Cumpleanos);
    ...
    MyModal.prototype.AgregarClientes = function () {
        var _this = this;
        this.Incomplete = false;
        ...
        var cliente = _constants__WEBPACK_IMPORTED_MODULE_5__["gv"].clientes.filter(function (cliente) {
            return cliente[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].identificador] === _this.Cliente.Identificador;
        });
    ...
    MyModal.prototype.Cambio = function () {
    ...
    MyModal.prototype.PayCredit = function () {
        var _this = this;
        this.Incomplete = false;
        this.btn_disabled = true;
        switch (this.Selection) {
            case 'Posponer':
                ...
                var fecha = new Date(this.In.Posponer.Date);
            ...
            case 'Re estructurar':
                ...
                var fecha_restructura = new Date(this.In.Re_Estructurar.Date);
    ...
    MyModal.prototype.AgregarAval = function () {
        var _a;
        _constants__WEBPACK_IMPORTED_MODULE_5__["gv"].AvalArr.push((_a = {},
            _a[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].direccion] = this.Aval.Calle + '#' + this.Aval.NumeroExt + '#' + this.Aval.NumeroInt + '#' + this.Aval.Colonia + '#' +
                this.Aval.Municipio + '#' + this.Aval.Estado,
            _a[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].nombre] = this.Aval.Nombre + '#' + this.Aval.ApellidoP + '#' + this.Aval.ApellidoM,
            _a[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].telefono] = this.Aval.Telefono,
            _a[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].curp] = this.Aval.CURP,
            _a[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].nacimiento] = this.Aval.Cumpleanos,
            _a[_constants__WEBPACK_IMPORTED_MODULE_5__["gv"].sexo] = this.Aval.Sexo,
            _a));
        this.modalCtrl.dismiss({
            'dismissed': true
        });
    };
    MyModal.prototype.AgregarProducto = function () {
    ...
    MyModal.prototype.CambioPagoNum = function (Pago, Num_Pagos) {
        if (Pago === '') {
            Pago = '0';
        }
        if (Num_Pagos === '') {
    ...
    MyModal.ctorParameters = function () { return [
...
var MyModalModule = /** @class */ (function () {
...
//# sourceMappingURL=default~pages-admin-admin-module~pages-clients-clients-module~pages-credit-credit-module~pages-login~d284721b-es5.js.map