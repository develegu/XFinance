...
var CreditComponent = /** @class */ (function () {
    function CreditComponent(modalController, db, gf) {
    ...
    CreditComponent.prototype.ngOnInit = function () {
        ...
        this.db.collection(src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["gv"].FB_Organizaciones).doc(src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["gv"].usuario[src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["gv"].organizacion]).collection(src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["gv"].FB_Productos)
            .get().subscribe(function (serverItems) {
            serverItems.forEach(function (product) {
                _this.ArrProductos.push(product.data());
                console.log(product.data());
            });
        });
    };
    CreditComponent.prototype.GetClient = function () {
    ...
    CreditComponent.prototype.presentAvalModal = function () {
    ...
    CreditComponent.prototype.AgregarGarantia = function () {
        var _a;
        this.ArrGarantias.push((_a = {},
            _a[src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["gv"].identificador] = '',
            _a[src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["gv"].marca] = '',
            _a[src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["gv"].articulo] = '',
            _a));
    };
    CreditComponent.prototype.EliminarGarantia = function (index) {
        this.ArrGarantias.splice(index, 1);
    };
    CreditComponent.prototype.AgregarCredito = function () {
        var _this = this;
        this.Alerta = false;
        this.Btn_Desactivado = true;
        for (var x = 0; x < this.ArrGarantias.length; x++) {
        ...
        if (this.in.Horario === '') {
            ...
            var hora = new Date(this.in.Horario);
        ...
        this.gf.RegistratCredito(parseInt(this.in.Num_Pagos), this.cliente[src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["gv"].nombre], this.cliente[src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["gv"].key], parseInt(this.in.Credito), this.in.Fecha, this.in.Periodo, parseInt(this.in.Pago), this.in.IDCliente, parseInt(this.in.Efectivo), this.in.Total_Credito, this.in.Deposito, this.in.Horario, this.ArrGarantias, this.in.Folio, src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["gv"].AvalArr, this.in.Razon, this.in.Cargo_Pago, this.cliente[src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["gv"].ID_Ubicacion])
            .then(function (res) {
            if (res) {
                _this.gf.Toast('Credito registrado', 2000);
                _this.in.Num_Pagos = '';
                _this.in.Fecha = '';
                _this.cliente = [];
                _this.in.Credito = '';
                ...
                _this.in.Horario = '';
                _this.in.Folio = '';
                _this.in.Cargo_Pago = 0;
                _this.in.Total_Credito = 0;
                _this.in.Cargo_Servicio = 0;
                src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["gv"].AvalArr = [];
                _this.ArrProductos = [];
            }
            else {
                _this.gf.Toast('Error al registrar el credito', 2000);
            }
            _this.Btn_Desactivado = false;
        });
    };
    CreditComponent.prototype.CambioPagoNum = function (Pago, Num_Pagos) {
        if (Pago === '') {
            Pago = '0';
        }
        if (Num_Pagos === '') {
    ...
    CreditComponent.prototype.CambioCargoPorServicio = function () {
        if (this.in.Efectivo === '') {
            this.in.Efectivo = '0';
        }
    ...
    CreditComponent.prototype.ProductoSeleccionado = function () {
    ...
    CreditComponent.ctorParameters = function () { return [
...
var CreditRoutingModule = /** @class */ (function () {
    function CreditRoutingModule() {
    }
...
//# sourceMappingURL=pages-credit-credit-module-es5.js.map